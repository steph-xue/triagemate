...
<p align="center"><img src="docs/screenshots/layout1.png" alt="User flow diagram part 1" width="800"></p>

<p align="center"><img src="docs/screenshots/layout2.png" alt="User flow diagram part 2" width="800"></p>
...
<p align="center"><img src="docs/screenshots/landing.jpg" alt="Landing Screen" height="400"></p>
...
<p align="center"><img src="docs/screenshots/profile.jpg" alt="Profile Screen" height="400"></p>
...
<p align="center">
  <img src="docs/screenshots/input1.jpg" alt="Symptom Input Screen 1" height="400">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/screenshots/input2.jpg" alt="Symptom Input Screen 2" height="400">
</p>
...
<p align="center"><img src="docs/screenshots/processing.jpg" alt="Processing Screen" height="400"></p>
...
<p align="center">
  <img src="docs/screenshots/results1.jpg" alt="Triage Results Screen 1" height="400">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/screenshots/results2.jpg" alt="Triage Results Screen 2" height="400">
</p>
...
<p align="center"><img src="docs/screenshots/success.jpg" alt="Submission Confirmation Screen" height="400"></p>
...
<p align="center">
  <img src="docs/screenshots/chinese-input.png" alt="Chinese Symptom Input" height="400">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/screenshots/chinese-result.png" alt="Translated Triage Result" height="400">
</p>
...
There are two main ways to run TriageMate: 
1. Open it directly in the Expo Go application 
2. Build and run the project locally on your own machine.
...
Follow the steps below to set up and run the application on your own machine. This project requires both a frontend and backend server running at the same time, along with the Expo Go application installed on your phone.
...
> **Note:** This project requires Node.js 20.19.4+, per Expo SDK 54's supported versions.
```bash
node --version
npm --version
```
